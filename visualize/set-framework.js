...
for (var i in frame_data.schedule) {
    ...
    $('#schedule-tbody').append($('<tr>').attr('id', 'schedule-week-' + week_count)
        ...
        .append($('<td>').attr('id', 'date-' + frame_data.schedule[i].tuesday.date)
            .append($('<div>').append($('<strong>').append($('<small>').html(frame_data.schedule[i].tuesday.date.slice(-5)))))
        )
        .append($('<td>').attr('id', 'date-' + frame_data.schedule[i].wednesday.date)
            .append($('<div>').append($('<strong>').append($('<small>').html(frame_data.schedule[i].wednesday.date.slice(-5)))))
        )
        .append($('<td>').attr('id', 'date-' + frame_data.schedule[i].thursday.date)
            .append($('<div>').append($('<strong>').append($('<small>').html(frame_data.schedule[i].thursday.date.slice(-5)))))
        )
        .append($('<td>').attr('id', 'date-' + frame_data.schedule[i].friday.date)
            .append($('<div>').append($('<strong>').append($('<small>').html(frame_data.schedule[i].friday.date.slice(-5)))))
        )
        .append($('<td>').attr('id', 'date-' + frame_data.schedule[i].saturday.date)
            .append($('<div>').append($('<strong>').append($('<small>').html(frame_data.schedule[i].saturday.date.slice(-5)))))
        )
        .append($('<td>').attr('id', 'date-' + frame_data.schedule[i].sunday.date)
            .append($('<div>').append($('<strong>').append($('<small>').html(frame_data.schedule[i].sunday.date.slice(-5)))))
        )
