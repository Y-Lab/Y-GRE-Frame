...
$('#footer-info').append($('<p>').append('Contact: ').append($('<a>').attr('href', 'mailto:' + footer_data.site.support + '?subject=Mail From Y-GRE Frame Website').html(footer_data.site.support)));