...
$('#footer-info').append($('<p>').append($('<i>').attr('aria-hidden', 'true').addClass('fa fa-paper-plane')).append(' Contact: ').append($('<a>').attr('href', 'mailto:' + footer_data.site.support + '?subject=Mail From Y-GRE Frame Website').html(footer_data.site.support)));